    ...
    <div class="container pt-5 d-flex justify-content-center">
        <div class="row shadow  mt-5 p-4 bg-biru-tua rounded" style="height: 68vh;">
            <div class="col-lg-7 d-flex flex-column align-items-center justify-content-center">
                <h1 class="text-center fw-bolder mb-5 color-putih" style="font-size: 48px">LOGIN</h1>
                <form action="/auth" method="post" class="d-flex flex-column align-items-center">
                    @csrf
                    <div class="row" style="width: 90%">
                        <div class="col-md-12 mb-4 form-floating">
                            ...
                            <label for="email" class="ms-3 text-secondary">Email Address</label>
                        </div>
                        <div class="col-md-12 mb-5 form-floating">
                            ...
                            <label for="pass" class="ms-3 text-secondary">Password</label>
                        </div>
